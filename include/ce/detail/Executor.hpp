...
namespace ce
{
    ...
    ExecutorHelper<fhash, ExecutionToken<fhash, T, R, FArgs...>, ExecutorBase<T, Derived>, T, R, FArgs...>
    ...
    template <class T, class Derived>
    template <uint32_t fhash, class R, class... FArgs>
    ExecutorHelper<fhash, ConstExecutionToken<fhash, T, R, FArgs...>, ExecutorBase<T, Derived>, T, R, FArgs...>
    ...
    template <size_t FHash, class T, class R, class... FArgs>
    ExecutionToken<FHash, T, R, FArgs...>::ExecutionToken(R (T::*func)(FArgs...))
        : m_func(func)
    {
    }
    ...
    template <size_t FHash, class T, class R, class... FArgs>
    ConstExecutionToken<FHash, T, R, FArgs...>::ConstExecutionToken(R (T::*func)(FArgs...) const)
        : m_func(func)
    {
    }
